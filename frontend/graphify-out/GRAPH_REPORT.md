...
## Corpus Check
- 70 files · ~46,602 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 429 nodes · 699 edges · 23 communities (19 shown, 4 thin omitted)
...
- `CagarBudayaDetailPage()` --calls--> `getThemeColors()`  [EXTRACTED]
  app/cagar-budaya/[slug]/page.tsx → lib/theme.ts
- `StatistikPage()` --calls--> `getStatusColorBg()`  [EXTRACTED]
  app/statistik/page.tsx → lib/siteStatus.ts
- `StatistikPage()` --calls--> `getStatusColorText()`  [EXTRACTED]
  app/statistik/page.tsx → lib/siteStatus.ts
...
Cohesion: 0.06
Nodes (45): ThemeValue, CATEGORY_CONFIG, StatistikPage(), STATUS_CONFIG, TINGKAT_CONFIG, useAnimatedCounter(), ALL_CATEGORIES, HomeClient() (+37 more)
...
### Community 11 - "SiteDetailPanel.tsx"
Cohesion: 0.09
Nodes (31): CagarBudayaDetailPage(), DetailPageProps, generateMetadata(), DetailGallery(), DetailGalleryProps, captionStyle, closeBtnStyle, counterStyle (+23 more)

### Community 15 - "next.config.ts"
Cohesion: 0.29
Nodes (5): apiPattern, isLocalHost, MediaPattern, nextConfig, remotePatterns

## Knowledge Gaps
- **163 isolated node(s):** `$schema`, `Site`, `katColor`, `statusColor`, `GalleryItem` (+158 more)
...
- **Why does `SmartImage()` connect `SiteDetailPanel.tsx` to `HomeClient.tsx`, `SiteForm.tsx`, `edit/page.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Site` connect `HomeClient.tsx` to `SiteDetailPanel.tsx`, `Map.tsx`?**
