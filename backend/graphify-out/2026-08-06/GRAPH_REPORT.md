...
## Corpus Check
- 54 files · ~52,689 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 254 nodes · 353 edges · 33 communities (14 shown, 19 thin omitted)
...
Cohesion: 0.12
Nodes (18): addGallery, create, findAll, findById, findBySlug, remove, removeGallery, update (+10 more)
...
Cohesion: 0.10
Nodes (15): app, env, prisma, login, me, healthCheck(), authMiddleware(), AuthRequest (+7 more)
