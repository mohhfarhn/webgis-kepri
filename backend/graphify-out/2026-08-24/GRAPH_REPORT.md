# Graph Report - backend  (2026-08-06)

## Corpus Check
- 54 files · ~52,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 256 nodes · 360 edges · 33 communities (14 shown, 19 thin omitted)
...
- Makam Belanda (Dutch Tomb) Image
...
3. `fail()` - 12 edges
4. `validateCagarCreate()` - 10 edges
5. `validateCagarUpdate()` - 10 edges
6. `compilerOptions` - 10 edges
7. `AppError` - 9 edges
8. `isPrismaError()` - 6 edges
9. `isNotFoundError()` - 6 edges
10. `Semantic Extraction (LLM Subagents)` - 6 edges
...
Cohesion: 0.11
Nodes (21): addGallery, create, findAll, findById, findBySlug, remove, removeGallery, update (+13 more)

### Community 3 - "dependencies"
Cohesion: 0.08
Nodes (25): bcrypt, cors, dotenv, express, express-rate-limit, helmet, jsonwebtoken, morgan (+17 more)

### Community 4 - "auth.routes.ts"
Cohesion: 0.11
Nodes (14): app, env, prisma, login, me, healthCheck(), AuthRequest, notFoundHandler() (+6 more)
...
## Knowledge Gaps
- **99 isolated node(s):** `$schema`, `name`, `version`, `description`, `main` (+94 more)
